...
public class UnoOnline
{
   ...
   public static void main (String[] args)
   {
      ...
      PasswordValidator pv = new PasswordValidator(); //instantiate new password validator object 
      pv.run(); //calling run method of the passwordvalidator object
   }
   /**
...
class PasswordValidator //new class for password validator
{
